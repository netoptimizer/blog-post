...
queuing this object to a remote CPU is also a cross-CPU scalability
bottleneck.  (Details: The kernels slab memory allocator is also challenged
as the per-CPU slab caches loose their effect).
